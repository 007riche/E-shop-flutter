...
class ProductsProvider with ChangeNotifier {
      ...
      productsSnapshot.docs.forEach((element) {
        _products.insert(
          ...
          Product(
            ...
            brandName: element.get('productBrand'),
            description: element.get('productDescription'),
            price: double.parse(element.get('price')),
            imageUrl: [
              element.get('productImageUrl'),
            ],
            productCategories: [
  ...
  List<Product> get feedsproducts {
    return _products.where((product) => product.quantity! > 10).toList();
  }

  List<Product>? findByCategory(String categoryName) {
    List filtered = _products
        .where((product) => product.productCategories!.contains(categoryName))
        .toList();
    print(filtered);
    print("Cat recieved: " + categoryName);
    return _products
        .where((product) => product.productCategories!.contains(categoryName))
        .toList();
    // _products
    ...
    //           product.productCategories!.toList().map(
    //             (category) {
    //               category.trim().toLowerCase();
    //               print("Cat passed: " + categoryName.toLowerCase());
    //               print("filtered Cat passed: " + category.toLowerCase());
    //             },
    //           ),
    //     )
    //     .toList();
  ...
  // List<Product>? findByBrand(List<String> brandSelected) {
  //   List<Product> filteredBrands = brandSelected.contains("All")
  //       ? products
  //       : _products
  //           .where((product) => brandSelected.contains(product.brandName))
  //           .toList();
  //   filteredBrands.forEach((element) {
  //     // ignore: avoid_print
  //     print(element.brandName);
  //     print("Filter products by brands: ${filteredBrands}");
  //   });
  //   print(filteredBrands);

  //   if (brandSelected.contains("All")) {
  //     print("${filteredBrands.length} filtered from the provider (ALL)");
  //     return _products;
  //   } else {
  //     print("${filteredBrands.length} filtered from the provider");
  //     return _products
  //         .where((product) => brandSelected.contains(product.brandName))
  //         .toList();
  //   }
  ...
  List<Product>? findByBrand(Set<String> brandSelected) {
    return _products
        .where((product) => brandSelected.contains(product.brandName))
        .toList();
  }

  List<Product> filteredBrands = [];
  ...
  void findByBrands(Set<String> brandSelected) {
    List<Product> products = [..._products];
    // List<Product> filteredBrands;
    // brandSelected.contains("All")
    //     ? filteredBrands = products
    //     :
    filteredBrands = products
        .where((product) => brandSelected.contains(product.brandName))
        .toList();
    print("filtered products based on brands $filteredBrands");
    notifyListeners();
  }
  ...
  List<Product>? searchProductQuery(String textQuery) {
    return _products
        .where((product) =>
            product.name.toLowerCase().contains(textQuery.toLowerCase()) ||
            product.description!
                .toLowerCase()
...
/**
 final List<Product> _products = [
    ...
    Product(
        ...
        name: 'Adeliber Dresses for Womens',
        description:
    ...
    Product(
        ...
        name: 'Latitude 5411 14" Notebook',
        description:
    ...
    Product(
        ...
        name: 'New Apple MacBook Pro with Apple',
        description:
    ...
    Product(
        ...
        name: 'Sofa Couch for Two People',
        description:
    ...
    Product(
        ...
        name: 'Delta Children Plastic Toddler Bed',
        description:
    ...
    Product(
        ...
        name: 'Flash[ Furniture ,]Nantucket 6 Piece',
        description:
    ...
    Product(
        ...
        name: 'Homall 4 Pieces Patio Outdoor[ Furniture ,]Sets',
        description:
    ...
    Product(
        ...
        name: 'Ashley[ Furniture ,]Signature Design',
        description:
    ...
    Product(
        ...
        name: 'YAMAY Smart Watch 2020 Ver',
        description:
